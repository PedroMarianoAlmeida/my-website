...
const MultipleChoiceMultipleResults = ({ question, rightAnswers, wrongAnswers, explanation, setRunNewQuestion, ...props }) => {
    const [allAnswers] = useState(shuffleArray([...rightAnswers, ...wrongAnswers])); //Run only one time
...
export default MultipleChoiceMultipleResults;