    ...
    <div>
      <div>
        <Navbar color="light" light expand="md" className="fixed-top">
          ...
          >
            <Nav
              className={`${!isOpen ? "d-none" : ""} d-${sizeToggle}-flex`}
              navbar
            >
              ...
              <UncontrolledDropdown nav inNavbar>
                ...
                <DropdownMenu right>
                  <Link href="/blog/publications/functions">
                    <DropdownItem>
                      <a className="text-dark"> Function </a>
                    </DropdownItem>
                  </Link>
                  <Link href="/blog/publications/free-content">
                    <DropdownItem>
                      <a className="text-dark"> Free Dev Content </a>
                    </DropdownItem>
                  </Link>
                </DropdownMenu>
              </UncontrolledDropdown>
              ...
              <UncontrolledDropdown nav inNavbar>
                ...
                <DropdownMenu right>
                  ...
                  <DropdownItemToGo
                    adress="dynamicAdressCodeTips"
                    as="/code-tips/next-js"
                    name="Next.js"
                  />
                  <DropdownItem divider />
                  <DropdownItemToGo
                    adress="dynamicAdressCodeTips"
                    as="/code-tips/bootstrap"
                    name="Bootstrap"
                  />
                  <DropdownItemToGo
                    adress="dynamicAdressCodeTips"
                    as="/code-tips/reactstrap"
                    name="ReactStrap"
                  />
                  <DropdownItemToGo
                    adress="dynamicAdressCodeTips"
                  ...
                  <DropdownItemToGo
                    adress="dynamicAdressCodeTips"
                    as="/code-tips/javascript"
                    name="JavaScript"
                  />
                  <DropdownItemToGo
                    adress="dynamicAdressCodeTips"
                    as="/code-tips/vs-code"
                    name="VS Code"
                  />
                  <DropdownItem divider />
                  <DropdownItemToGo
                    adress="dynamicAdressCodeTips"
                    as="/code-tips/web-tools"
                    name="Web Tools"
                  />
                  <DropdownItemToGo
                    adress="dynamicAdressCodeTips"
